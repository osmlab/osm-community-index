...
:--- | :--- | :----------
 ...
 `matrix` | <sub><img width="20" src="https://cdn.jsdelivr.net/gh/osmlab/osm-community-index@main/dist/img/matrix.svg"/> </sub> | A [Matrix](https://matrix.org/) chat, e.g. [Riot Chat](https://matrix.org/docs/projects/client/riot.html). For resources available via the `matrix.org` server, `account` should contain the room or community identifier (with leading '#' or '+' as needed).
