(function (global, factory) {
  ...
  var features = {
  	...
  	"de-ostwestfalen-lippe": {
  		type: "Feature",
  		id: "de-ostwestfalen-lippe",
  		properties: {
  		},
  		geometry: {
  			type: "Polygon",
  	...
  	minneapolis_st_paul_metro: {
  		type: "Feature",
  		id: "minneapolis_st_paul_metro",
  		properties: {
  		},
  		geometry: {
  			type: "Polygon",
  ...
  var resources = {
  	"cape-coast-youthmappers": {
  		id: "cape-coast-youthmappers",
  		featureId: "cape_coast_gh",
  		type: "twitter",
  		...
  		url: "https://twitter.com/YouthmappersUCC",
  		contacts: [
  			{
  				name: "Enock Seth Nyamador",
  				email: "kwadzo459@gmail.com"
  			}
  		]
  	},
  	"osm-gh-facebook": {
  		...
  		url: "https://www.facebook.com/OSMGhana/",
  		contacts: [
  			{
  				name: "Enock Seth Nyamador",
  				email: "kwadzo459@gmail.com"
  	...
  	"osm-gh-twitter": {
  		...
  		description: "Follow us on Twitter: {url}",
  		url: "https://twitter.com/osmghana",
  		contacts: [
  			{
  				name: "Enock Seth Nyamador",
  				email: "kwadzo459@gmail.com"
  	...
  	"talk-gh": {
  		...
  		url: "https://lists.openstreetmap.org/listinfo/talk-gh",
  		contacts: [
  			{
  				name: "Enock Seth Nyamador",
  				email: "kwadzo459@gmail.com"
  	...
  	"osm-mg-facebook": {
  		...
  		url: "https://www.facebook.com/groups/1601381123461284/",
  		contacts: [
  			{
  				name: "Brice Ramamonjy",
  				email: "rafaby21@gmail.com"
  			},
  			{
  				name: "Dolly Andriatsiferana",
  				email: "privatemajory@gmail.com"
  			}
  		]
  	},
  	"talk-mg": {
  		...
  		url: "https://lists.openstreetmap.org/listinfo/talk-mg",
  		contacts: [
  			{
  				name: "Brice Ramamonjy",
  				email: "rafaby21@gmail.com"
  	...
  	"OSM-BGD-facebook": {
  		...
  		url: "https://www.facebook.com/groups/osmbd/",
  		contacts: [
  			{
  				name: "Ahasanul Hoque",
  				email: "hoque.ahasan@gmail.com"
  			}
  		]
  	},
  	"OSM-India-facebook": {
  		id: "OSM-India-facebook",
  		...
  		url: "https://www.facebook.com/groups/mappingindia/",
  		contacts: [
  			{
  				name: "Jinal Foflia",
  				email: "fofliajinal@gmail.com"
  			},
  			{
  				name: "Arun Ganesh",
  	...
  	"OSM-India-Puducherry-Facebook": {
  		id: "OSM-India-Puducherry-Facebook",
  		...
  		url: "https://www.facebook.com/FSHMP",
  		contacts: [
  			{
  				name: "Kamalavelan",
  	...
  	"OSM-India-Puducherry-Matrix": {
  		id: "OSM-India-Puducherry-Matrix",
  		featureId: "india_puducherry",
  		type: "matrix",
  	...
  	"OSM-IDN-facebook": {
  		...
  		url: "https://www.facebook.com/groups/osm.id/",
  		contacts: [
  			{
  				name: "Yantisa Akhadi",
  	...
  	"OSM-japan-facebook": {
  		...
  		url: "https://www.facebook.com/groups/osmjapan/",
  		contacts: [
  			{
  				name: "Satoshi IIDA",
  				email: "nyampire@gmail.com"
  			}
  		]
  	},
  	"OSM-japan-mailinglist": {
  		id: "OSM-japan-mailinglist",
  		featureId: "japan",
  		type: "mailinglist",
  		...
  		url: "https://lists.openstreetmap.org/listinfo/talk-ja",
  		contacts: [
  			{
  				name: "OSMF Japan",
  				email: "info@osmf.jp"
  	...
  	"OSM-japan-twitter": {
  		...
  		url: "https://twitter.com/hashtag/osmjp",
  		contacts: [
  			{
  				name: "Satoshi IIDA",
  				email: "nyampire@gmail.com"
  	...
  	"OSM-MY-facebook": {
  		...
  		url: "https://www.facebook.com/groups/openstreetmapMY/",
  		contacts: [
  			{
  				name: "Mohd Saidin",
  				email: "projekopenstreetmap@hotmail.com"
  			}
  		]
  	},
  	"OSM-MY-forum": {
  		...
  		url: "https://forum.openstreetmap.org/viewforum.php?id=60",
  		contacts: [
  			{
  				name: "Mohd Saidin",
  				email: "projekopenstreetmap@hotmail.com"
  	...
  	"OSM-MY-matrix": {
  		...
  		contacts: [
  			{
  				name: "Ahmad Amsyar",
  				email: "OfficiallyAhmad@protonmail.ch"
  			}
  		]
  	},
  	"OSM-MNG-facebook": {
  		...
  		url: "https://www.facebook.com/groups/OSM.Mongolia/",
  		contacts: [
  			{
  				name: " ",
  				email: "talk-mn@openstreetmap.org"
  			}
  		]
  	},
  	"OSM-MMR-facebook": {
  		...
  		url: "https://www.facebook.com/groups/osmmm/",
  		contacts: [
  			{
  				name: "Yan Naung Oak",
  				email: "yan@phandeeyar.org"
  			},
  			{
  				name: "Patrick Oswald",
  				email: "patrickoswald.omm@gmail.com"
  			},
  			{
  				name: "Set Khaing Oo",
  				email: "setkhaing@phandeeyar.org"
  			}
  		]
  	},
  	"OSM-Nepal-facebook": {
  		id: "OSM-Nepal-facebook",
  		featureId: "NPL",
  		type: "facebook",
  		...
  		url: "https://www.facebook.com/groups/mapkathmandu/",
  		contacts: [
  			{
  				name: "Kshitiz Khanal",
  				email: "khanal1990@gmail.com"
  			}
  		]
  	},
  	"OSM-PH-facebook": {
  		id: "OSM-PH-facebook",
  		featureId: "philippines",
  		type: "facebook",
  		countryCodes: [
  			"ph"
  		],
  		...
  		url: "https://www.facebook.com/OSMPH/",
  		contacts: [
  			{
  				name: "Maning Sambale",
  			...
  			{
  				name: "OSM PH Group",
  				email: "osm.pilipinas@gmail.com"
  			}
  		]
  	},
  	"OSM-PH-mailinglist": {
  		id: "OSM-PH-mailinglist",
  		featureId: "philippines",
  		type: "mailinglist",
  		countryCodes: [
  			"ph"
  		...
  		url: "https://lists.openstreetmap.org/pipermail/talk-ph/",
  		contacts: [
  			{
  				name: "Maning Sambale",
  				email: "emmanuel.sambale@gmail.com"
  	...
  	"OSM-PH-slack": {
  		...
  		signupUrl: "https://osmph-chat.herokuapp.com/",
  		url: "https://osmph.slack.com",
  		contacts: [
  			{
  				name: "Maning Sambale",
  				email: "emmanuel.sambale@gmail.com"
  	...
  	"OSM-PH-telegram": {
  		...
  		url: "https://t.me/osmph",
  		contacts: [
  			{
  				name: "Erwin Olario",
  				email: "govvin@gmail.com"
  			},
  			{
  				name: "OSM PH Group",
  				email: "osm.pilipinas@gmail.com"
  	...
  	"OSM-RU-forum": {
  		...
  		url: "https://forum.openstreetmap.org/viewforum.php?id=21",
  		contacts: [
  			{
  				name: "Ilya Zverev",
  	...
  	"OSM-LKA-facebook": {
  		...
  		url: "https://www.facebook.com/groups/142058222659672/",
  		contacts: [
  			{
  				name: "Karan Suthakaran",
  				email: "karansuthakaran@yahoo.com"
  			}
  		]
  	},
  	"OSM-TW-facebook": {
  		...
  		url: "https://www.facebook.com/groups/OpenStreetMap.TW/",
  		contacts: [
  			{
  				name: "Nobody 沒有人 (Public mail)",
  				email: "hiboard@openstreetmap.tw"
  			}
  		]
  	},
  	"OSM-TW-mailinglist": {
  		id: "OSM-TW-mailinglist",
  		featureId: "taiwan",
  		type: "mailinglist",
  		...
  		contacts: [
  			{
  				name: "Nobody 沒有人 (Public email)",
  				email: "hiboard@openstreetmap.tw"
  			}
  		]
  	},
  	"OSM-TH-CNX-meetup": {
  		id: "OSM-TH-CNX-meetup",
  		featureId: "thailand_cnx",
  		type: "meetup",
  		countryCodes: [
  			"th"
  		],
  		...
  		url: "https://forum.openstreetmap.org/viewforum.php?id=46",
  		contacts: [
  			{
  				name: "Team Chiang Mai",
  				email: "meetup-cnx@openstreetmap.in.th"
  			}
  		]
  	},
  	"OSM-TH-forum": {
  		id: "OSM-TH-forum",
  		featureId: "thailand_full",
  		type: "forum",
  		countryCodes: [
  			"th"
  		],
  	...
  	"at-forum": {
  		...
  		url: "https://forum.openstreetmap.org/viewforum.php?id=89",
  		contacts: [
  			{
  				name: "emga",
  				email: "emgaosm@gmail.com"
  			}
  		]
  	},
  	"at-mailinglist": {
  		...
  		url: "https://lists.openstreetmap.org/listinfo/talk-at",
  		contacts: [
  			{
  				name: "AT community",
  				email: "info@openstreetmap.at"
  			}
  		]
  	},
  	"at-twitter": {
  	...
  	"osmgraz-meetup": {
  		...
  		url: "https://wiki.openstreetmap.org/wiki/Graz/Stammtisch",
  		contacts: [
  			{
  				name: "Michael Maier",
  				email: "michael.maier@secure.mailbox.org"
  			}
  		]
  	},
  	"osmgraz-twitter": {
  	...
  	"osm-at": {
  		...
  		url: "https://www.openstreetmap.at/",
  		contacts: [
  			{
  				name: "AT community",
  				email: "info@openstreetmap.at"
  	...
  	"be-facebook": {
  		...
  		url: "https://www.facebook.com/groups/1419016881706058/",
  		contacts: [
  			{
  				name: "BE community",
  	...
  	"be-forum": {
  		...
  		url: "https://forum.openstreetmap.org/viewforum.php?id=29",
  		contacts: [
  			{
  				name: "BE community",
  				email: "community@osm.be"
  	...
  	"be-mailinglist": {
  		...
  		url: "https://lists.openstreetmap.org/listinfo/talk-be",
  		contacts: [
  			{
  				name: "BE community",
  				email: "community@osm.be"
  	...
  	"be-meetup": {
  		...
  		url: "https://meetup.com/OpenStreetMap-Belgium/",
  		contacts: [
  			{
  				name: "BE community",
  				email: "community@osm.be"
  	...
  	"talk-cz-mailinglist": {
  		...
  		url: "https://openstreetmap.cz/talkcz",
  		contacts: [
  			{
  				name: "osmcz",
  				email: "dev@openstreetmap.cz"
  			}
  		]
  	},
  	"dk-forum": {
  		...
  		url: "https://forum.openstreetmap.org/viewforum.php?id=48",
  		contacts: [
  			{
  				name: "Talk-dk-owner",
  				email: "talk-dk-owner@openstreetmap.org"
  			}
  		]
  	},
  	"dk-irc": {
  	...
  	"dk-mailinglist": {
  		...
  		url: "https://lists.openstreetmap.org/listinfo/talk-dk",
  		contacts: [
  			{
  				name: "Talk-dk-owner",
  				email: "talk-dk-owner@openstreetmap.org"
  		...
  		contacts: [
  			{
  				...
  				email: "talk-fi-owner@openstreetmap.org"
  			}
  		]
  	},
  	"fi-irc": {
  	...
  	"fr-facebook": {
  		...
  		url: "https://www.facebook.com/osmfr",
  		contacts: [
  			{
  				name: "OpenStreetMap France",
  				email: "contact@openstreetmap.fr"
  			}
  		]
  	},
  	"fr-forum": {
  		...
  		url: "https://forum.openstreetmap.fr/",
  		contacts: [
  			{
  				name: "OpenStreetMap France",
  				email: "contact@openstreetmap.fr"
  	...
  	"fr-mailinglist": {
  		...
  		url: "https://lists.openstreetmap.org/listinfo/talk-fr",
  		contacts: [
  			{
  				name: "OpenStreetMap France",
  				email: "contact@openstreetmap.fr"
  	...
  	"de-berlin-mailinglist": {
  		id: "de-berlin-mailinglist",
  		featureId: "de-berlin-brandenburg",
  		type: "mailinglist",
  		...
  		url: "https://lists.openstreetmap.de/listinfo/berlin",
  		contacts: [
  			{
  				name: "FOSSGIS e.V.",
  				email: "info@fossgis.de"
  			}
  		]
  	},
  	"de-berlin-meetup": {
  	...
  	"de-ostwestfalen-lippe-mailinglist": {
  		id: "de-ostwestfalen-lippe-mailinglist",
  		featureId: "de-ostwestfalen-lippe",
  		type: "mailinglist",
  		...
  		url: "https://gt.owl.de/mailman/listinfo/osm",
  		contacts: [
  			{
  				name: "Florian Lohoff",
  				email: "osm-owner@gt.owl.de"
  			}
  		]
  	},
  	"osm-de": {
  	...
  	"hu-facebook": {
  		...
  		url: "https://www.facebook.com/groups/osm.hu/",
  		contacts: [
  			{
  				name: "Ferenc Veres",
  	...
  	"hu-forum": {
  		...
  		url: "https://groups.google.com/forum/#!forum/openstreetmap-hungary",
  		contacts: [
  			{
  				name: "Ferenc Veres",
  				email: "info@openstreetmap.hu"
  	...
  	"hu-meetup": {
  		...
  		url: "https://www.meetup.com/OpenStreetMap-Hungary",
  		contacts: [
  			{
  				name: "Ferenc Veres",
  				email: "info@openstreetmap.hu"
  	...
  	"it-facebook": {
  		...
  		url: "https://www.facebook.com/OpenStreetMap.Italia/",
  		contacts: [
  			{
  				name: "Simone Cortesi",
  	...
  	"it-mailinglist": {
  		...
  		url: "https://lists.openstreetmap.org/listinfo/talk-it",
  		contacts: [
  			{
  				name: "Simone Cortesi",
  				email: "simone@cortesi.com"
  	...
  	"OSM-Rome-meetup": {
  		...
  		url: "https://wiki.openstreetmap.org/wiki/Rome/Incontro",
  		contacts: [
  			{
  				name: "Martin Koppenhoefer",
  				email: "dieterdreist@gmail.com"
  			}
  		]
  	},
  	"South-Tyrol-Mailing-List": {
  		id: "South-Tyrol-Mailing-List",
  		featureId: "south_tyrol",
  		type: "mailinglist",
  		countryCodes: [
  			"it"
  		],
  		...
  		url: "https://lists.openstreetmap.org/listinfo/talk-it-southtyrol",
  		contacts: [
  			{
  				name: "Martin Raifer",
  	...
  	"talk-it-lazio": {
  		...
  		signupUrl: "https://lists.openstreetmap.org/listinfo/talk-it-lazio",
  		url: "https://lists.openstreetmap.org/listinfo/talk-it-lazio",
  		contacts: [
  			{
  				name: "Martin Koppenhoefer",
  				email: "dieterdreist@gmail.com"
  	...
  	"Trentino-Mailing-List": {
  		...
  		url: "https://lists.openstreetmap.org/listinfo/talk-it-trentino",
  		contacts: [
  			{
  				name: "Luca Delucchi",
  	...
  	"OSM-PL-facebook-group": {
  		...
  		url: "https://www.facebook.com/groups/500589303317858/",
  		contacts: [
  			{
  				name: "Michał Brzozowski",
  				email: "www.haxor@gmail.com"
  			}
  		]
  	},
  	"OSM-PL-forum": {
  		...
  		url: "https://forum.openstreetmap.org/viewforum.php?id=23",
  		contacts: [
  			{
  				name: "Daniel Koć",
  				email: "daniel@xn--ko-wla.pl"
  			},
  			{
  				name: "Ryszard Mikke",
  				email: "ryszard.mikke@gmail.com"
  			}
  		]
  	},
  	"OSM-ES-mailinglist": {
  		id: "OSM-ES-mailinglist",
  		type: "mailinglist",
  		featureId: "spain",
  		languageCodes: [
  			"es"
  		...
  		url: "https://lists.openstreetmap.org/listinfo/talk-es",
  		contacts: [
  			{
  				name: "Iván Sánchez",
  				email: "ivansanchez@escomposlinux.org"
  			}
  		]
  	},
  	"OSM-ES-telegram": {
  		...
  		url: "https://t.me/OSMes",
  		contacts: [
  			{
  				name: "Jorge Sanz",
  				email: "sanchi2@gmail.com"
  			}
  		]
  	},
  	"osm-se": {
  		...
  		contacts: [
  			{
  				name: "Talk-se-owner",
  				email: "talk-se-owner@openstreetmap.org"
  			}
  		]
  	},
  	"se-facebook": {
  		...
  		url: "https://www.facebook.com/groups/osmsweden/",
  		contacts: [
  			{
  				name: "Talk-se-owner",
  				email: "talk-se-owner@openstreetmap.org"
  	...
  	"se-forum": {
  		...
  		url: "https://forum.openstreetmap.org/viewforum.php?id=4",
  		contacts: [
  			{
  				name: "Talk-se-owner",
  				email: "talk-se-owner@openstreetmap.org"
  	...
  	"se-mailinglist": {
  		...
  		url: "https://lists.openstreetmap.org/listinfo/talk-se",
  		contacts: [
  			{
  				name: "Talk-se-owner",
  				email: "talk-se-owner@openstreetmap.org"
  	...
  	"se-twitter": {
  		...
  		description: "Follow us on Twitter: {url}",
  		url: "https://twitter.com/openstreetmapse",
  		contacts: [
  			{
  				name: "Talk-se-owner",
  				email: "talk-se-owner@openstreetmap.org"
  	...
  	"Nottingham-OSM-pub-meetup": {
  		id: "Nottingham-OSM-pub-meetup",
  		featureId: "east_midlands_uk",
  		type: "group",
  		...
  		url: "https://wiki.openstreetmap.org/wiki/Nottingham/Pub-meetup",
  		contacts: [
  			{
  				name: "Jerry Clough",
  				email: "SK53.osm@gmail.com"
  			}
  		]
  	},
  	"gb-mailinglist": {
  		...
  		url: "https://lists.openstreetmap.org/listinfo/talk-gb",
  		contacts: [
  			{
  				name: "UK mailing list",
  				email: "talk-gb-owner@lists.openstreetmap.org"
  			}
  		]
  	},
  	"mappa-mercia-group": {
  		id: "mappa-mercia-group",
  		featureId: "england-west-midlands",
  		type: "group",
  		countryCodes: [
  			"gb"
  		],
  		...
  		contacts: [
  			{
  				name: "Brian Prangle",
  				email: "community@mappa-mercia.org"
  			}
  		]
  	},
  	"gb-irc": {
  	...
  	"OSM-CA-Slack": {
  		...
  		name: "OSM-CA Slack",
  		description: "All are welcome! Sign up at {signupUrl}.",
  		signupUrl: "https://slackinviteosmcanada.herokuapp.com/",
  		url: "https://osm-ca.slack.com/",
  		contacts: [
  			{
  				name: "Denis Carriere",
  	...
  	"OSM-Vancouver-meetup": {
  		id: "OSM-Vancouver-meetup",
  		featureId: "vancouver_metro",
  		type: "meetup",
  		...
  		url: "https://www.meetup.com/OpenStreetMap-Vancouver/",
  		contacts: [
  			{
  				name: "Paul Norman",
  			...
  			{
  				name: "Peter Chin",
  				email: "bpchin@gmail.com"
  			}
  		],
  		events: [
  			{
  				name: "April Metrotown Mappy Hour",
  				description: "Mappy Hour is the time and place for discussion of OpenStreetMap, from surveying data to consuming data. Beginners welcome. Bring your questions.",
  				when: "2018-04-27 18:30",
  				where: "Firefighters' Public House, 6515 Bonsor Avenue, Burnaby, BC",
  				url: "https://www.meetup.com/OpenStreetMap-Vancouver/events/qzsbsmyxgbkc/"
  			}
  		]
  	},
  	"OSM-CU-telegram": {
  		...
  		url: "https://telegram.me/OSM_Cuba",
  		contacts: [
  			{
  				name: "Talk-cu Owner",
  				email: "talk-cu-owner@openstreetmap.org"
  			}
  		]
  	},
  	"OSM-NI-telegram": {
  		...
  		url: "https://telegram.me/MapaNica",
  		contacts: [
  			{
  				name: "Talk-ni Owner",
  				email: "talk-ni-owner@openstreetmap.org"
  			}
  		]
  	},
  	"Bay-Area-OpenStreetMappers": {
  		id: "Bay-Area-OpenStreetMappers",
  		featureId: "sf_bay_area",
  		type: "meetup",
  		...
  		url: "https://www.meetup.com/Bay-Area-OpenStreetMappers/",
  		contacts: [
  			{
  				name: "Ben Discoe",
  				email: "bdiscoe@gmail.com"
  			}
  		]
  	},
  	"Central-Pennsylvania-OSM": {
  		id: "Central-Pennsylvania-OSM",
  		featureId: "central_pa",
  		type: "facebook",
  	...
  	"Code-for-San-Jose-Slack": {
  		id: "Code-for-San-Jose-Slack",
  		featureId: "south_sf_bay_area",
  		type: "slack",
  		countryCodes: [
  			"us"
  		],
  		...
  		signupUrl: "https://slackin-c4sj.herokuapp.com/",
  		url: "https://codeforsanjose.slack.com/",
  		contacts: [
  			{
  				name: "OSM Bay Area mailing list",
  				email: "talk-us-sfbay@openstreetmap.org"
  			}
  		]
  	},
  	"Dallas-Fort-Worth-OSM": {
  		id: "Dallas-Fort-Worth-OSM",
  		featureId: "dfw_metro",
  		type: "group",
  		...
  		contacts: [
  			{
  				name: "Andrew Matheny",
  				email: "andrewdmatheny@gmail.com"
  			}
  		]
  	},
  	GeoPhilly: {
  		id: "GeoPhilly",
  		featureId: "philly_metro",
  		type: "meetup",
  		name: "GeoPhilly",
  		countryCodes: [
  			"us"
  	...
  	MapMinnesota: {
  		id: "MapMinnesota",
  		featureId: "minneapolis_st_paul_metro",
  		type: "meetup",
  		name: "MapMinnesota",
  		countryCodes: [
  			"us"
  		...
  		url: "https://www.meetup.com/Map-Minnesota/",
  		contacts: [
  			{
  				name: "Ian Dees",
  	...
  	"Maptime-ME-meetup": {
  		id: "Maptime-ME-meetup",
  		featureId: "portland_me",
  		type: "meetup",
  		name: "MaptimeME",
  		countryCodes: [
  			"us"
  		...
  		url: "https://www.meetup.com/MaptimeME/",
  		contacts: [
  			{
  				name: "Malcolm Toon",
  				email: "malcolm@foreflight.com"
  			}
  		]
  	},
  	"OpenCleveland-meetup": {
  		id: "OpenCleveland-meetup",
  		featureId: "cleveland",
  		type: "meetup",
  		name: "Open Cleveland",
  		countryCodes: [
  		...
  		url: "https://www.meetup.com/open-cleveland/",
  		contacts: [
  			{
  				name: "Will Skora",
  				email: "skorasaurus@gmail.com"
  			},
  			{
  				name: "Anastasia Diamond-Ortiz",
  				email: "anastasia.diamond@gmail.com"
  			}
  		],
  		events: [
  			{
  				name: "Wednesday Meetup / Hack Night",
  				description: "Meets weekly - programming experience is not necessary!",
  				when: "2018-04-18 18:00",
  				where: "The Tech Hive, 6815 Euclid Ave, Cleveland, OH",
  				url: "https://www.meetup.com/open-cleveland/events/lcjdnpyxgbxb/"
  			},
  			{
  				name: "Wednesday Meetup / Hack Night",
  				description: "Meets weekly - programming experience is not necessary!",
  				when: "2018-04-25 18:00",
  				where: "The Tech Hive, 6815 Euclid Ave, Cleveland, OH",
  				url: "https://www.meetup.com/open-cleveland/events/lcjdnpyxgbhc/"
  			},
  			{
  				name: "Wednesday Meetup / Hack Night",
  				description: "Meets weekly - programming experience is not necessary!",
  				when: "2018-05-02 18:00",
  				where: "The Tech Hive, 6815 Euclid Ave, Cleveland, OH",
  				url: "https://www.meetup.com/open-cleveland/events/lcjdnpyxhbdb/"
  			},
  			{
  				name: "Wednesday Meetup / Hack Night",
  				description: "Meets weekly - programming experience is not necessary!",
  				when: "2018-05-09 18:00",
  				where: "The Tech Hive, 6815 Euclid Ave, Cleveland, OH",
  				url: "https://www.meetup.com/open-cleveland/events/lcjdnpyxhbmb/"
  			},
  			{
  				name: "Wednesday Meetup / Hack Night",
  				description: "Meets weekly - programming experience is not necessary!",
  				when: "2018-05-16 18:00",
  				where: "The Tech Hive, 6815 Euclid Ave, Cleveland, OH",
  				url: "https://www.meetup.com/open-cleveland/events/lcjdnpyxhbvb/"
  			},
  			{
  				name: "Wednesday Meetup / Hack Night",
  				description: "Meets weekly - programming experience is not necessary!",
  				when: "2018-05-23 18:00",
  				where: "The Tech Hive, 6815 Euclid Ave, Cleveland, OH",
  				url: "https://www.meetup.com/open-cleveland/events/lcjdnpyxhbfc/"
  			},
  			{
  				name: "Wednesday Meetup / Hack Night",
  				description: "Meets weekly - programming experience is not necessary!",
  				when: "2018-05-30 18:00",
  				where: "The Tech Hive, 6815 Euclid Ave, Cleveland, OH",
  				url: "https://www.meetup.com/open-cleveland/events/lcjdnpyxhbnc/"
  			}
  		]
  	},
  	"OSM-Boston": {
  		id: "OSM-Boston",
  		featureId: "boston_metro",
  		type: "meetup",
  		...
  		url: "https://www.meetup.com/OpenStreetMap-Boston/",
  		contacts: [
  			{
  				name: "Lars Ahlzen",
  				email: "lars@ahlzen.com"
  			}
  		]
  	},
  	"OSM-Central-Salish-Sea": {
  		id: "OSM-Central-Salish-Sea",
  		featureId: "mt_vernon_wa",
  		type: "meetup",
  		...
  		url: "https://www.meetup.com/OpenStreetMap-Central-Salish-Sea/",
  		contacts: [
  			{
  				name: "Clifford Snow",
  	...
  	"OSM-Chattanooga": {
  		...
  		url: "https://www.facebook.com/groups/123483951073256",
  		contacts: [
  			{
  				name: "Jenny Park",
  				email: "tennessee@tpl.org"
  			},
  			{
  				name: "Randal Hale",
  	...
  	"OSM-Colorado": {
  		...
  		url: "https://www.meetup.com/OSM-Colorado/",
  		contacts: [
  			{
  				name: "Russell Deffner",
  				email: "russdeffner@gmail.com"
  			}
  		]
  	},
  	"OSM-NYC": {
  		...
  		url: "https://www.meetup.com/osm-nyc/",
  		contacts: [
  			{
  				name: "Jeff Ferzoco",
  				email: "jferzoco@carto.com"
  			}
  		]
  	},
  	"OSM-Portland": {
  		id: "OSM-Portland",
  		featureId: "portland_or",
  		type: "meetup",
  		...
  		url: "https://www.meetup.com/OpenStreetMap-Portland/",
  		contacts: [
  			{
  				name: "Madeline Steele",
  				email: "madeline.steele@gmail.com"
  			}
  		]
  	},
  	"OSM-Seattle": {
  		...
  		url: "https://www.meetup.com/OpenStreetMap-Seattle/",
  		contacts: [
  			{
  				name: "Clifford Snow",
  				email: "clifford@snowandsnow.us"
  			...
  			{
  				name: "Chase Stephens",
  				email: "seattlefyi@gmail.com"
  			},
  			{
  				name: "Paul McCombs",
  				email: "pablo@imperium.org"
  			}
  		]
  	},
  	"OSM-SoCal": {
  		...
  		url: "https://www.meetup.com/OSM-Southern-California/",
  		contacts: [
  			{
  				name: "Charlotte Wolter",
  				email: "techlady@techlady.com"
  			}
  		]
  	},
  	"OSM-South-Bay": {
  		...
  		url: "https://www.meetup.com/Code-for-San-Jose/",
  		contacts: [
  			{
  				name: "OSM Bay Area mailing list",
  				email: "talk-us-sfbay@openstreetmap.org"
  	...
  	"OSM-Tampa-Bay": {
  		...
  		url: "https://www.meetup.com/osmtampabay/",
  		contacts: [
  			{
  				name: "Coleman McCormick",
  				email: "cmccormick@gmail.com"
  			}
  		]
  	},
  	"OSM-US-Slack": {
  	...
  	"OSM-US": {
  		...
  		contacts: [
  			...
  			{
  				name: "Bryan Housel",
  				email: "bryan@openstreetmap.us"
  			}
  		]
  	},
  	"OSM-Utah": {
  		id: "OSM-Utah",
  		featureId: "salt_lake_city",
  		type: "meetup",
  		...
  		url: "https://www.meetup.com/OpenStreetMap-Utah/",
  		contacts: [
  			{
  	...
  	"OSM-Wyoming": {
  		...
  		url: "https://www.meetup.com/OSM-Wyoming/",
  		contacts: [
  			{
  				name: "Russell Deffner",
  				email: "russdeffner@gmail.com"
  	...
  	"PHXGeo-meetup": {
  		...
  		url: "https://www.meetup.com/PHXGeo/",
  		contacts: [
  			{
  				name: "Ryan Arp",
  				email: "ryan@arpconsultinggroup.com"
  			}
  		]
  	},
  	"PHXGeo-twitter": {
  	...
  	"Western-Slope-facebook": {
  		id: "Western-Slope-facebook",
  		featureId: "grand_junction_co",
  		type: "facebook",
  		...
  		url: "https://www.facebook.com/wsosm/",
  		contacts: [
  			{
  				name: "Aaron Young",
  				email: "aaron@kaartgroup.com"
  			}
  		]
  	},
  	...
  	"Maptime-Australia-Slack": {
  		id: "Maptime-Australia-Slack",
  		featureId: "australia_full",
  		type: "slack",
  		countryCodes: [
  			"au"
  		],
  		...
  		signupUrl: "https://bit.ly/maptimeau",
  		url: "https://maptimeaustralia.slack.com",
  		contacts: [
  			{
  				name: "David Dean",
  				email: "ddean@ieee.org"
  			},
  			{
  				name: "Philip Mallis",
  				email: "philip.mallis@unimelb.edu.au"
  			},
  			{
  				name: "Edoardo Neerhut",
  				email: "ed@mapillary.com"
  			}
  		]
  	},
  	"talk-au": {
  		...
  		url: "https://lists.openstreetmap.org/listinfo/talk-au",
  		contacts: [
  			{
  				name: "Ben Kelley",
  				email: "ben.kelley@gmail.com"
  			},
  			{
  				name: "Steve Bennett",
  				email: "stevagewp@gmail.com"
  			},
  			{
  				name: "Ian Sergeant",
  				email: "inas66+osm@gmail.com"
  			}
  		]
  	},
  	"OSM-AR-facebook": {
  		...
  		url: "https://www.facebook.com/OpenStreetMapArgentina/",
  		contacts: [
  			{
  				name: "OpenStreetMap Argentina",
  				email: "openstreetmap.org.ar@gmail.com"
  			}
  		]
  	},
  	"OSM-AR-forum": {
  		...
  		url: "https://forum.openstreetmap.org/viewforum.php?id=49",
  		contacts: [
  			{
  				name: "OpenStreetMap Argentina",
  				email: "openstreetmap.org.ar@gmail.com"
  	...
  	"OSM-AR-mailinglist": {
  		...
  		url: "https://lists.openstreetmap.org/pipermail/talk-ar/",
  		contacts: [
  			{
  				name: "OpenStreetMap Argentina",
  				email: "openstreetmap.org.ar@gmail.com"
  	...
  	"OSM-AR-twitter": {
  		...
  		url: "https://twitter.com/OpenStreetMapAr",
  		contacts: [
  			{
  				name: "OpenStreetMap Argentina",
  				email: "openstreetmap.org.ar@gmail.com"
  	...
  	"OSM-BO-mailinglist": {
  		...
  		url: "https://lists.openstreetmap.org/pipermail/talk-bo/",
  		contacts: [
  			{
  				name: "Marco Antonio",
  				email: "marcoantoniofrias@gmail.com"
  			}
  		]
  	},
  	"Bahia-telegram": {
  	...
  	"OSM-br-mailinglist": {
  		...
  		url: "https://lists.openstreetmap.org/pipermail/talk-br/",
  		contacts: [
  			{
  				name: "Arlindo Pereira",
  				email: "nighto@gmail.com"
  			}
  		]
  	},
  	"OSM-br-telegram": {
  		...
  		extendedDescription: "Join the community to learn more about OpenStreetMap, ask questions or participate in our meetings. Everyone is welcome!",
  		url: "https://t.me/OSMBrasil_Comunidade",
  		contacts: [
  			{
  				name: "Vitor George",
  		...
  		events: [
  			{
  				id: "webinar_mundogeo",
  				name: "Webinar: OpenStreetMap em Prefeituras e Empresas",
  				description: "Participe do webinar sobre como utilizar o OpenStreeMap em prefeituras e empresas.",
  				where: "Online",
  				when: "2018-05-02 14:30",
  				url: "http://mundogeo.com/webinar/webinar.html"
  			},
  			{
  				id: "mundogeo",
  				name: "Painel OpenStreetMap no MundoGeo #connect",
  				description: "Participe do painel sobre o OpenStreetMap no MundoGeo #connect.",
  				where: "São Paulo, SP, Brasil",
  				when: "2018-05-16 11:00",
  				url: "http://mundogeoconnect.com/2018/atividades-especiais/"
  			}
  		]
  	},
  	"OSM-br-twitter": {
  		...
  		description: "Follow us on Twitter at {url}",
  		url: "https://twitter.com/OpenStreetMapBR",
  		contacts: [
  			{
  				name: "Wille Marcel",
  				email: "wille@wille.blog.br"
  	...
  	"OSM-CL-facebook": {
  		...
  		extendedDescription: "Join the community to learn more about OpenStreetMap, ask questions or participate in our meetings. Everyone is welcome!",
  		url: "https://www.facebook.com/OpenStreetMap-Chile-145127198882915/",
  		contacts: [
  			{
  				name: "Julio Costa",
  				email: "julio.costa@openstreetmap.cl"
  			}
  		]
  	},
  	"OSM-CL-mailinglist": {
  		id: "OSM-CL-mailinglist",
  		featureId: "chile",
  		type: "mailinglist",
  		...
  		url: "https://lists.openstreetmap.org/pipermail/talk-cl/",
  		contacts: [
  			{
  				name: "Julio Costa",
  				email: "julio.costa@openstreetmap.cl"
  	...
  	"Maptime-Bogota": {
  		...
  		url: "https://www.meetup.com/Maptime-Colombia-OSM/",
  		contacts: [
  			{
  				name: "Andrés Gómez Casanova",
  				email: "angoca@gmail.com"
  			}
  		]
  	},
  	"OSM-CO-facebook": {
  		...
  		url: "https://www.facebook.com/groups/OsmCol/",
  		contacts: [
  			{
  				name: "Fredy Rivera",
  				email: "fredyrivera@gmail.com"
  			}
  		]
  	},
  	"OSM-CO-mailinglist": {
  		id: "OSM-CO-mailinglist",
  		featureId: "colombia",
  		type: "mailinglist",
  		...
  		url: "https://lists.openstreetmap.org/pipermail/talk-co/",
  		contacts: [
  			{
  				name: "Fredy Rivera",
  				email: "fredyrivera@gmail.com"
  	...
  	"OSM-CO-twitter": {
  		...
  		description: "Follow us on Twitter at {url}",
  		url: "https://twitter.com/OpenStreetMapCo",
  		contacts: [
  			{
  				name: "Fredy Rivera",
  				email: "fredyrivera@gmail.com"
  	...
  	"OSM-CO": {
  		...
  		url: "https://blog.openstreetmap.co/s657",
  		contacts: [
  			{
  				name: "Fredy Rivera",
  				email: "fredyrivera@gmail.com"
  	...
  	"OSM-EC-telegram": {
  		...
  		url: "https://telegram.me/MappingEcuador",
  		contacts: [
  			{
  				name: "Talk-ec Owner",
  				email: "talk-ec-owner@openstreetmap.org"
  			}
  		]
  	},
  	"OSM-PY-telegram": {
  		...
  		url: "https://telegram.me/osm_py",
  		contacts: [
  			{
  				name: "Talk-py Owner",
  				email: "talk-py-owner@openstreetmap.org"
  			}
  		]
  	},
  	"OSM-PE-facebook": {
  		...
  		url: "https://www.facebook.com/Osmpe",
  		contacts: [
  			{
  				name: "Diego Sangunietti",
  				email: "diego.sanguinetti@hotmail.com"
  			},
  			{
  				name: "Ruben Lopez M.",
  	...
  	"OSM-PE-mailinglist": {
  		...
  		url: "https://lists.openstreetmap.org/pipermail/talk-pe/",
  		contacts: [
  			{
  				name: "Diego Sangunietti",
  				email: "diego.sanguinetti@hotmail.com"
  	...
  	"OSM-PE-matrix": {
  		...
  		url: "https://matrix.to/#/#osmpe:matrix.org",
  		contacts: [
  			{
  				name: "Diego Sangunietti",
  				email: "diego.sanguinetti@hotmail.com"
